...
function initGL() {
    ...
    document.getElementById('nU').onchange = (e) => {
        let newnU = parseInt(document.getElementById('nU').value)
        surface.BufferData(cloverKnotVerts(newnU, 100, 2, 0.5));
        draw()
    }
    let nU = parseInt(document.getElementById('nU').value)
    surface.BufferData(cloverKnotVerts(nU, 100, 2, 0.5));
